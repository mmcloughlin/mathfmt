...
| `⦇` | `\limg` | Z NOTATION LEFT IMAGE BRACKET |
...
| `⦈` | `\rimg` | Z NOTATION RIGHT IMAGE BRACKET |
...
| `⃖` | `\LVec` | COMBINING LEFT ARROW ABOVE |
...
| `Ƶ` | `\Zbar` |  |
| `Ϙ` | `\Qoppa` | GREEK LETTER ARCHAIC KOPPA |
| `ϙ` | `\qoppa` | GREEK SMALL LETTER ARCHAIC KOPPA |
...
| `ℼ` | `\mathbb{\pi}` | DOUBLE-STRUCK SMALL PI |
| `⅁` | `\Game` |  |
...
| `ⅇ` | `\ExponetialE` | DOUBLE-STRUCK ITALIC SMALL E |
| `ⅈ` | `\ComplexI` | DOUBLE-STRUCK ITALIC SMALL I |
| `ⅉ` | `\ComplexJ` | DOUBLE-STRUCK ITALIC SMALL J |
...
| `☞` | `\pointright` | WHITE RIGHT POINTING INDEX |
...
| `➛` | `\draftingarrow` |  |
| `➢` | `\arrowbullet` | THREE-D TOP-LIGHTED RIGHTWARDS ARROWHEAD |
...
| `⤀` | `\psur` | RIGHTWARDS TWO-HEADED ARROW WITH VERTICAL STROKE |
...
| `⤔` | `\pinj` | RIGHTWARDS ARROW WITH TAIL WITH VERTICAL STROKE |
| `⤕` | `\finj` | RIGHTWARDS ARROW WITH TAIL WITH DOUBLE VERTICAL STROKE |
| `⤖` | `\bij` | RIGHTWARDS TWO-HEADED ARROW WITH TAIL |
...
| `⥎` | `\leftrightharpoonup` | LEFT BARB UP RIGHT BARB UP HARPOON |
| `⥏` | `\rightupdownharpoon` | UP BARB RIGHT DOWN BARB RIGHT HARPOON |
| `⥐` | `\leftrightharpoondown` | LEFT BARB DOWN RIGHT BARB DOWN HARPOON |
| `⥑` | `\leftupdownharpoon` | UP BARB LEFT DOWN BARB LEFT HARPOON |
...
| `ϐ` | `\varbeta` |  |
| `ϑ` | `\vartheta` |  |
| `ϒ` | `\upUpsilon` | GREEK UPSILON WITH HOOK SYMBOL |
| `ϕ` | `\phi` |  |
| `ϖ` | `\varpi` |  |
| `Ϛ` | `\Stigma` |  |
...
| `Ϡ` | `\Sampi` |  |
| `ϡ` | `\sampi` | GREEK SMALL LETTER SAMPI |
| `ϰ` | `\varkappa` |  |
| `ϱ` | `\varrho` |  |
| `ϴ` | `\upvarTheta` | GREEK CAPITAL THETA SYMBOL |
...
| `ℷ` | `\gimel` |  |
| `ℸ` | `\daleth` |  |
| `ℽ` | `\mathbb{\gamma}` | DOUBLE-STRUCK SMALL GAMMA |
...
| `𝑨` | `\mathbfit{A}` | MATHEMATICAL BOLD ITALIC CAPITAL A |
| `𝑩` | `\mathbfit{B}` | MATHEMATICAL BOLD ITALIC CAPITAL B |
| `𝑪` | `\mathbfit{C}` | MATHEMATICAL BOLD ITALIC CAPITAL C |
| `𝑫` | `\mathbfit{D}` | MATHEMATICAL BOLD ITALIC CAPITAL D |
| `𝑬` | `\mathbfit{E}` | MATHEMATICAL BOLD ITALIC CAPITAL E |
| `𝑭` | `\mathbfit{F}` | MATHEMATICAL BOLD ITALIC CAPITAL F |
| `𝑮` | `\mathbfit{G}` | MATHEMATICAL BOLD ITALIC CAPITAL G |
| `𝑯` | `\mathbfit{H}` | MATHEMATICAL BOLD ITALIC CAPITAL H |
| `𝑰` | `\mathbfit{I}` | MATHEMATICAL BOLD ITALIC CAPITAL I |
| `𝑱` | `\mathbfit{J}` | MATHEMATICAL BOLD ITALIC CAPITAL J |
| `𝑲` | `\mathbfit{K}` | MATHEMATICAL BOLD ITALIC CAPITAL K |
| `𝑳` | `\mathbfit{L}` | MATHEMATICAL BOLD ITALIC CAPITAL L |
| `𝑴` | `\mathbfit{M}` | MATHEMATICAL BOLD ITALIC CAPITAL M |
| `𝑵` | `\mathbfit{N}` | MATHEMATICAL BOLD ITALIC CAPITAL N |
| `𝑶` | `\mathbfit{O}` | MATHEMATICAL BOLD ITALIC CAPITAL O |
| `𝑷` | `\mathbfit{P}` | MATHEMATICAL BOLD ITALIC CAPITAL P |
| `𝑸` | `\mathbfit{Q}` | MATHEMATICAL BOLD ITALIC CAPITAL Q |
| `𝑹` | `\mathbfit{R}` | MATHEMATICAL BOLD ITALIC CAPITAL R |
| `𝑺` | `\mathbfit{S}` | MATHEMATICAL BOLD ITALIC CAPITAL S |
| `𝑻` | `\mathbfit{T}` | MATHEMATICAL BOLD ITALIC CAPITAL T |
| `𝑼` | `\mathbfit{U}` | MATHEMATICAL BOLD ITALIC CAPITAL U |
| `𝑽` | `\mathbfit{V}` | MATHEMATICAL BOLD ITALIC CAPITAL V |
| `𝑾` | `\mathbfit{W}` | MATHEMATICAL BOLD ITALIC CAPITAL W |
| `𝑿` | `\mathbfit{X}` | MATHEMATICAL BOLD ITALIC CAPITAL X |
| `𝒀` | `\mathbfit{Y}` | MATHEMATICAL BOLD ITALIC CAPITAL Y |
| `𝒁` | `\mathbfit{Z}` | MATHEMATICAL BOLD ITALIC CAPITAL Z |
| `𝒂` | `\mathbfit{a}` | MATHEMATICAL BOLD ITALIC SMALL A |
| `𝒃` | `\mathbfit{b}` | MATHEMATICAL BOLD ITALIC SMALL B |
| `𝒄` | `\mathbfit{c}` | MATHEMATICAL BOLD ITALIC SMALL C |
| `𝒅` | `\mathbfit{d}` | MATHEMATICAL BOLD ITALIC SMALL D |
| `𝒆` | `\mathbfit{e}` | MATHEMATICAL BOLD ITALIC SMALL E |
| `𝒇` | `\mathbfit{f}` | MATHEMATICAL BOLD ITALIC SMALL F |
| `𝒈` | `\mathbfit{g}` | MATHEMATICAL BOLD ITALIC SMALL G |
| `𝒉` | `\mathbfit{h}` | MATHEMATICAL BOLD ITALIC SMALL H |
| `𝒊` | `\mathbfit{i}` | MATHEMATICAL BOLD ITALIC SMALL I |
| `𝒋` | `\mathbfit{j}` | MATHEMATICAL BOLD ITALIC SMALL J |
| `𝒌` | `\mathbfit{k}` | MATHEMATICAL BOLD ITALIC SMALL K |
| `𝒍` | `\mathbfit{l}` | MATHEMATICAL BOLD ITALIC SMALL L |
| `𝒎` | `\mathbfit{m}` | MATHEMATICAL BOLD ITALIC SMALL M |
| `𝒏` | `\mathbfit{n}` | MATHEMATICAL BOLD ITALIC SMALL N |
| `𝒐` | `\mathbfit{o}` | MATHEMATICAL BOLD ITALIC SMALL O |
| `𝒑` | `\mathbfit{p}` | MATHEMATICAL BOLD ITALIC SMALL P |
| `𝒒` | `\mathbfit{q}` | MATHEMATICAL BOLD ITALIC SMALL Q |
| `𝒓` | `\mathbfit{r}` | MATHEMATICAL BOLD ITALIC SMALL R |
| `𝒔` | `\mathbfit{s}` | MATHEMATICAL BOLD ITALIC SMALL S |
| `𝒕` | `\mathbfit{t}` | MATHEMATICAL BOLD ITALIC SMALL T |
| `𝒖` | `\mathbfit{u}` | MATHEMATICAL BOLD ITALIC SMALL U |
| `𝒗` | `\mathbfit{v}` | MATHEMATICAL BOLD ITALIC SMALL V |
| `𝒘` | `\mathbfit{w}` | MATHEMATICAL BOLD ITALIC SMALL W |
| `𝒙` | `\mathbfit{x}` | MATHEMATICAL BOLD ITALIC SMALL X |
| `𝒚` | `\mathbfit{y}` | MATHEMATICAL BOLD ITALIC SMALL Y |
| `𝒛` | `\mathbfit{z}` | MATHEMATICAL BOLD ITALIC SMALL Z |
| `𝒜` | `\mathcal{A}` | MATHEMATICAL SCRIPT CAPITAL A |
| `𝒞` | `\mathcal{C}` | MATHEMATICAL SCRIPT CAPITAL C |
| `𝒟` | `\mathcal{D}` | MATHEMATICAL SCRIPT CAPITAL D |
| `𝒢` | `\mathcal{G}` | MATHEMATICAL SCRIPT CAPITAL G |
| `𝒥` | `\mathcal{J}` | MATHEMATICAL SCRIPT CAPITAL J |
| `𝒦` | `\mathcal{K}` | MATHEMATICAL SCRIPT CAPITAL K |
| `𝒩` | `\mathcal{N}` | MATHEMATICAL SCRIPT CAPITAL N |
| `𝒪` | `\mathcal{O}` | MATHEMATICAL SCRIPT CAPITAL O |
| `𝒫` | `\mathcal{P}` | MATHEMATICAL SCRIPT CAPITAL P |
| `𝒬` | `\mathcal{Q}` | MATHEMATICAL SCRIPT CAPITAL Q |
| `𝒮` | `\mathcal{S}` | MATHEMATICAL SCRIPT CAPITAL S |
| `𝒯` | `\mathcal{T}` | MATHEMATICAL SCRIPT CAPITAL T |
| `𝒰` | `\mathcal{U}` | MATHEMATICAL SCRIPT CAPITAL U |
| `𝒱` | `\mathcal{V}` | MATHEMATICAL SCRIPT CAPITAL V |
| `𝒲` | `\mathcal{W}` | MATHEMATICAL SCRIPT CAPITAL W |
| `𝒳` | `\mathcal{X}` | MATHEMATICAL SCRIPT CAPITAL X |
| `𝒴` | `\mathcal{Y}` | MATHEMATICAL SCRIPT CAPITAL Y |
| `𝒵` | `\mathcal{Z}` | MATHEMATICAL SCRIPT CAPITAL Z |
| `𝒶` | `\mathcal{a}` | MATHEMATICAL SCRIPT SMALL A |
| `𝒷` | `\mathcal{b}` | MATHEMATICAL SCRIPT SMALL B |
| `𝒸` | `\mathcal{c}` | MATHEMATICAL SCRIPT SMALL C |
| `𝒹` | `\mathcal{d}` | MATHEMATICAL SCRIPT SMALL D |
| `𝒻` | `\mathcal{f}` | MATHEMATICAL SCRIPT SMALL F |
| `𝒽` | `\mathcal{h}` | MATHEMATICAL SCRIPT SMALL H |
| `𝒾` | `\mathcal{i}` | MATHEMATICAL SCRIPT SMALL I |
| `𝒿` | `\mathcal{j}` | MATHEMATICAL SCRIPT SMALL J |
| `𝓀` | `\mathcal{k}` | MATHEMATICAL SCRIPT SMALL K |
| `𝓁` | `\mathcal{l}` | MATHEMATICAL SCRIPT SMALL L |
| `𝓂` | `\mathcal{m}` | MATHEMATICAL SCRIPT SMALL M |
| `𝓃` | `\mathcal{n}` | MATHEMATICAL SCRIPT SMALL N |
| `𝓅` | `\mathcal{p}` | MATHEMATICAL SCRIPT SMALL P |
| `𝓆` | `\mathcal{q}` | MATHEMATICAL SCRIPT SMALL Q |
| `𝓇` | `\mathcal{r}` | MATHEMATICAL SCRIPT SMALL R |
| `𝓈` | `\mathcal{s}` | MATHEMATICAL SCRIPT SMALL S |
| `𝓉` | `\mathcal{t}` | MATHEMATICAL SCRIPT SMALL T |
| `𝓊` | `\mathcal{u}` | MATHEMATICAL SCRIPT SMALL U |
| `𝓋` | `\mathcal{v}` | MATHEMATICAL SCRIPT SMALL V |
| `𝓌` | `\mathcal{w}` | MATHEMATICAL SCRIPT SMALL W |
| `𝓍` | `\mathcal{x}` | MATHEMATICAL SCRIPT SMALL X |
| `𝓎` | `\mathcal{y}` | MATHEMATICAL SCRIPT SMALL Y |
| `𝓏` | `\mathcal{z}` | MATHEMATICAL SCRIPT SMALL Z |
| `𝓐` | `\mbfscrA` | MATHEMATICAL BOLD SCRIPT CAPITAL A |
| `𝓑` | `\mbfscrB` | MATHEMATICAL BOLD SCRIPT CAPITAL B |
| `𝓒` | `\mbfscrC` | MATHEMATICAL BOLD SCRIPT CAPITAL C |
| `𝓓` | `\mbfscrD` | MATHEMATICAL BOLD SCRIPT CAPITAL D |
| `𝓔` | `\mbfscrE` | MATHEMATICAL BOLD SCRIPT CAPITAL E |
| `𝓕` | `\mbfscrF` | MATHEMATICAL BOLD SCRIPT CAPITAL F |
| `𝓖` | `\mbfscrG` | MATHEMATICAL BOLD SCRIPT CAPITAL G |
| `𝓗` | `\mbfscrH` | MATHEMATICAL BOLD SCRIPT CAPITAL H |
| `𝓘` | `\mbfscrI` | MATHEMATICAL BOLD SCRIPT CAPITAL I |
| `𝓙` | `\mbfscrJ` | MATHEMATICAL BOLD SCRIPT CAPITAL J |
| `𝓚` | `\mbfscrK` | MATHEMATICAL BOLD SCRIPT CAPITAL K |
| `𝓛` | `\mbfscrL` | MATHEMATICAL BOLD SCRIPT CAPITAL L |
| `𝓜` | `\mbfscrM` | MATHEMATICAL BOLD SCRIPT CAPITAL M |
| `𝓝` | `\mbfscrN` | MATHEMATICAL BOLD SCRIPT CAPITAL N |
| `𝓞` | `\mbfscrO` | MATHEMATICAL BOLD SCRIPT CAPITAL O |
| `𝓟` | `\mbfscrP` | MATHEMATICAL BOLD SCRIPT CAPITAL P |
| `𝓠` | `\mbfscrQ` | MATHEMATICAL BOLD SCRIPT CAPITAL Q |
| `𝓡` | `\mbfscrR` | MATHEMATICAL BOLD SCRIPT CAPITAL R |
| `𝓢` | `\mbfscrS` | MATHEMATICAL BOLD SCRIPT CAPITAL S |
| `𝓣` | `\mbfscrT` | MATHEMATICAL BOLD SCRIPT CAPITAL T |
| `𝓤` | `\mbfscrU` | MATHEMATICAL BOLD SCRIPT CAPITAL U |
| `𝓥` | `\mbfscrV` | MATHEMATICAL BOLD SCRIPT CAPITAL V |
| `𝓦` | `\mbfscrW` | MATHEMATICAL BOLD SCRIPT CAPITAL W |
| `𝓧` | `\mbfscrX` | MATHEMATICAL BOLD SCRIPT CAPITAL X |
| `𝓨` | `\mbfscrY` | MATHEMATICAL BOLD SCRIPT CAPITAL Y |
| `𝓩` | `\mbfscrZ` | MATHEMATICAL BOLD SCRIPT CAPITAL Z |
| `𝓪` | `\mbfscra` | MATHEMATICAL BOLD SCRIPT SMALL A |
| `𝓫` | `\mbfscrb` | MATHEMATICAL BOLD SCRIPT SMALL B |
| `𝓬` | `\mbfscrc` | MATHEMATICAL BOLD SCRIPT SMALL C |
| `𝓭` | `\mbfscrd` | MATHEMATICAL BOLD SCRIPT SMALL D |
| `𝓮` | `\mbfscre` | MATHEMATICAL BOLD SCRIPT SMALL E |
| `𝓯` | `\mbfscrf` | MATHEMATICAL BOLD SCRIPT SMALL F |
| `𝓰` | `\mbfscrg` | MATHEMATICAL BOLD SCRIPT SMALL G |
| `𝓱` | `\mbfscrh` | MATHEMATICAL BOLD SCRIPT SMALL H |
| `𝓲` | `\mbfscri` | MATHEMATICAL BOLD SCRIPT SMALL I |
| `𝓳` | `\mbfscrj` | MATHEMATICAL BOLD SCRIPT SMALL J |
| `𝓴` | `\mbfscrk` | MATHEMATICAL BOLD SCRIPT SMALL K |
| `𝓵` | `\mbfscrl` | MATHEMATICAL BOLD SCRIPT SMALL L |
| `𝓶` | `\mbfscrm` | MATHEMATICAL BOLD SCRIPT SMALL M |
| `𝓷` | `\mbfscrn` | MATHEMATICAL BOLD SCRIPT SMALL N |
| `𝓸` | `\mbfscro` | MATHEMATICAL BOLD SCRIPT SMALL O |
| `𝓹` | `\mbfscrp` | MATHEMATICAL BOLD SCRIPT SMALL P |
| `𝓺` | `\mbfscrq` | MATHEMATICAL BOLD SCRIPT SMALL Q |
| `𝓻` | `\mbfscrr` | MATHEMATICAL BOLD SCRIPT SMALL R |
| `𝓼` | `\mbfscrs` | MATHEMATICAL BOLD SCRIPT SMALL S |
| `𝓽` | `\mbfscrt` | MATHEMATICAL BOLD SCRIPT SMALL T |
| `𝓾` | `\mbfscru` | MATHEMATICAL BOLD SCRIPT SMALL U |
| `𝓿` | `\mbfscrv` | MATHEMATICAL BOLD SCRIPT SMALL V |
| `𝔀` | `\mbfscrw` | MATHEMATICAL BOLD SCRIPT SMALL W |
| `𝔁` | `\mbfscrx` | MATHEMATICAL BOLD SCRIPT SMALL X |
| `𝔂` | `\mbfscry` | MATHEMATICAL BOLD SCRIPT SMALL Y |
| `𝔃` | `\mbfscrz` | MATHEMATICAL BOLD SCRIPT SMALL Z |
...
| `𝕬` | `\mbffrakA` | MATHEMATICAL BOLD FRAKTUR CAPITAL A |
| `𝕭` | `\mbffrakB` | MATHEMATICAL BOLD FRAKTUR CAPITAL B |
| `𝕮` | `\mbffrakC` | MATHEMATICAL BOLD FRAKTUR CAPITAL C |
| `𝕯` | `\mbffrakD` | MATHEMATICAL BOLD FRAKTUR CAPITAL D |
| `𝕰` | `\mbffrakE` | MATHEMATICAL BOLD FRAKTUR CAPITAL E |
| `𝕱` | `\mbffrakF` | MATHEMATICAL BOLD FRAKTUR CAPITAL F |
| `𝕲` | `\mbffrakG` | MATHEMATICAL BOLD FRAKTUR CAPITAL G |
| `𝕳` | `\mbffrakH` | MATHEMATICAL BOLD FRAKTUR CAPITAL H |
| `𝕴` | `\mbffrakI` | MATHEMATICAL BOLD FRAKTUR CAPITAL I |
| `𝕵` | `\mbffrakJ` | MATHEMATICAL BOLD FRAKTUR CAPITAL J |
| `𝕶` | `\mbffrakK` | MATHEMATICAL BOLD FRAKTUR CAPITAL K |
| `𝕷` | `\mbffrakL` | MATHEMATICAL BOLD FRAKTUR CAPITAL L |
| `𝕸` | `\mbffrakM` | MATHEMATICAL BOLD FRAKTUR CAPITAL M |
| `𝕹` | `\mbffrakN` | MATHEMATICAL BOLD FRAKTUR CAPITAL N |
| `𝕺` | `\mbffrakO` | MATHEMATICAL BOLD FRAKTUR CAPITAL O |
| `𝕻` | `\mbffrakP` | MATHEMATICAL BOLD FRAKTUR CAPITAL P |
| `𝕼` | `\mbffrakQ` | MATHEMATICAL BOLD FRAKTUR CAPITAL Q |
| `𝕽` | `\mbffrakR` | MATHEMATICAL BOLD FRAKTUR CAPITAL R |
| `𝕾` | `\mbffrakS` | MATHEMATICAL BOLD FRAKTUR CAPITAL S |
| `𝕿` | `\mbffrakT` | MATHEMATICAL BOLD FRAKTUR CAPITAL T |
| `𝖀` | `\mbffrakU` | MATHEMATICAL BOLD FRAKTUR CAPITAL U |
| `𝖁` | `\mbffrakV` | MATHEMATICAL BOLD FRAKTUR CAPITAL V |
| `𝖂` | `\mbffrakW` | MATHEMATICAL BOLD FRAKTUR CAPITAL W |
| `𝖃` | `\mbffrakX` | MATHEMATICAL BOLD FRAKTUR CAPITAL X |
| `𝖄` | `\mbffrakY` | MATHEMATICAL BOLD FRAKTUR CAPITAL Y |
| `𝖅` | `\mbffrakZ` | MATHEMATICAL BOLD FRAKTUR CAPITAL Z |
| `𝖆` | `\mbffraka` | MATHEMATICAL BOLD FRAKTUR SMALL A |
| `𝖇` | `\mbffrakb` | MATHEMATICAL BOLD FRAKTUR SMALL B |
| `𝖈` | `\mbffrakc` | MATHEMATICAL BOLD FRAKTUR SMALL C |
| `𝖉` | `\mbffrakd` | MATHEMATICAL BOLD FRAKTUR SMALL D |
| `𝖊` | `\mbffrake` | MATHEMATICAL BOLD FRAKTUR SMALL E |
| `𝖋` | `\mbffrakf` | MATHEMATICAL BOLD FRAKTUR SMALL F |
| `𝖌` | `\mbffrakg` | MATHEMATICAL BOLD FRAKTUR SMALL G |
| `𝖍` | `\mbffrakh` | MATHEMATICAL BOLD FRAKTUR SMALL H |
| `𝖎` | `\mbffraki` | MATHEMATICAL BOLD FRAKTUR SMALL I |
| `𝖏` | `\mbffrakj` | MATHEMATICAL BOLD FRAKTUR SMALL J |
| `𝖐` | `\mbffrakk` | MATHEMATICAL BOLD FRAKTUR SMALL K |
| `𝖑` | `\mbffrakl` | MATHEMATICAL BOLD FRAKTUR SMALL L |
| `𝖒` | `\mbffrakm` | MATHEMATICAL BOLD FRAKTUR SMALL M |
| `𝖓` | `\mbffrakn` | MATHEMATICAL BOLD FRAKTUR SMALL N |
| `𝖔` | `\mbffrako` | MATHEMATICAL BOLD FRAKTUR SMALL O |
| `𝖕` | `\mbffrakp` | MATHEMATICAL BOLD FRAKTUR SMALL P |
| `𝖖` | `\mbffrakq` | MATHEMATICAL BOLD FRAKTUR SMALL Q |
| `𝖗` | `\mbffrakr` | MATHEMATICAL BOLD FRAKTUR SMALL R |
| `𝖘` | `\mbffraks` | MATHEMATICAL BOLD FRAKTUR SMALL S |
| `𝖙` | `\mbffrakt` | MATHEMATICAL BOLD FRAKTUR SMALL T |
| `𝖚` | `\mbffraku` | MATHEMATICAL BOLD FRAKTUR SMALL U |
| `𝖛` | `\mbffrakv` | MATHEMATICAL BOLD FRAKTUR SMALL V |
| `𝖜` | `\mbffrakw` | MATHEMATICAL BOLD FRAKTUR SMALL W |
| `𝖝` | `\mbffrakx` | MATHEMATICAL BOLD FRAKTUR SMALL X |
| `𝖞` | `\mbffraky` | MATHEMATICAL BOLD FRAKTUR SMALL Y |
| `𝖟` | `\mbffrakz` | MATHEMATICAL BOLD FRAKTUR SMALL Z |
...
| `𝘈` | `\mathsfit{A}` | MATHEMATICAL SANS-SERIF ITALIC CAPITAL A |
| `𝘉` | `\mathsfit{B}` | MATHEMATICAL SANS-SERIF ITALIC CAPITAL B |
| `𝘊` | `\mathsfit{C}` | MATHEMATICAL SANS-SERIF ITALIC CAPITAL C |
| `𝘋` | `\mathsfit{D}` | MATHEMATICAL SANS-SERIF ITALIC CAPITAL D |
| `𝘌` | `\mathsfit{E}` | MATHEMATICAL SANS-SERIF ITALIC CAPITAL E |
| `𝘍` | `\mathsfit{F}` | MATHEMATICAL SANS-SERIF ITALIC CAPITAL F |
| `𝘎` | `\mathsfit{G}` | MATHEMATICAL SANS-SERIF ITALIC CAPITAL G |
| `𝘏` | `\mathsfit{H}` | MATHEMATICAL SANS-SERIF ITALIC CAPITAL H |
| `𝘐` | `\mathsfit{I}` | MATHEMATICAL SANS-SERIF ITALIC CAPITAL I |
| `𝘑` | `\mathsfit{J}` | MATHEMATICAL SANS-SERIF ITALIC CAPITAL J |
| `𝘒` | `\mathsfit{K}` | MATHEMATICAL SANS-SERIF ITALIC CAPITAL K |
| `𝘓` | `\mathsfit{L}` | MATHEMATICAL SANS-SERIF ITALIC CAPITAL L |
| `𝘔` | `\mathsfit{M}` | MATHEMATICAL SANS-SERIF ITALIC CAPITAL M |
| `𝘕` | `\mathsfit{N}` | MATHEMATICAL SANS-SERIF ITALIC CAPITAL N |
| `𝘖` | `\mathsfit{O}` | MATHEMATICAL SANS-SERIF ITALIC CAPITAL O |
| `𝘗` | `\mathsfit{P}` | MATHEMATICAL SANS-SERIF ITALIC CAPITAL P |
| `𝘘` | `\mathsfit{Q}` | MATHEMATICAL SANS-SERIF ITALIC CAPITAL Q |
| `𝘙` | `\mathsfit{R}` | MATHEMATICAL SANS-SERIF ITALIC CAPITAL R |
| `𝘚` | `\mathsfit{S}` | MATHEMATICAL SANS-SERIF ITALIC CAPITAL S |
| `𝘛` | `\mathsfit{T}` | MATHEMATICAL SANS-SERIF ITALIC CAPITAL T |
| `𝘜` | `\mathsfit{U}` | MATHEMATICAL SANS-SERIF ITALIC CAPITAL U |
| `𝘝` | `\mathsfit{V}` | MATHEMATICAL SANS-SERIF ITALIC CAPITAL V |
| `𝘞` | `\mathsfit{W}` | MATHEMATICAL SANS-SERIF ITALIC CAPITAL W |
| `𝘟` | `\mathsfit{X}` | MATHEMATICAL SANS-SERIF ITALIC CAPITAL X |
| `𝘠` | `\mathsfit{Y}` | MATHEMATICAL SANS-SERIF ITALIC CAPITAL Y |
| `𝘡` | `\mathsfit{Z}` | MATHEMATICAL SANS-SERIF ITALIC CAPITAL Z |
| `𝘢` | `\mathsfit{a}` | MATHEMATICAL SANS-SERIF ITALIC SMALL A |
| `𝘣` | `\mathsfit{b}` | MATHEMATICAL SANS-SERIF ITALIC SMALL B |
| `𝘤` | `\mathsfit{c}` | MATHEMATICAL SANS-SERIF ITALIC SMALL C |
| `𝘥` | `\mathsfit{d}` | MATHEMATICAL SANS-SERIF ITALIC SMALL D |
| `𝘦` | `\mathsfit{e}` | MATHEMATICAL SANS-SERIF ITALIC SMALL E |
| `𝘧` | `\mathsfit{f}` | MATHEMATICAL SANS-SERIF ITALIC SMALL F |
| `𝘨` | `\mathsfit{g}` | MATHEMATICAL SANS-SERIF ITALIC SMALL G |
| `𝘩` | `\mathsfit{h}` | MATHEMATICAL SANS-SERIF ITALIC SMALL H |
| `𝘪` | `\mathsfit{i}` | MATHEMATICAL SANS-SERIF ITALIC SMALL I |
| `𝘫` | `\mathsfit{j}` | MATHEMATICAL SANS-SERIF ITALIC SMALL J |
| `𝘬` | `\mathsfit{k}` | MATHEMATICAL SANS-SERIF ITALIC SMALL K |
| `𝘭` | `\mathsfit{l}` | MATHEMATICAL SANS-SERIF ITALIC SMALL L |
| `𝘮` | `\mathsfit{m}` | MATHEMATICAL SANS-SERIF ITALIC SMALL M |
| `𝘯` | `\mathsfit{n}` | MATHEMATICAL SANS-SERIF ITALIC SMALL N |
| `𝘰` | `\mathsfit{o}` | MATHEMATICAL SANS-SERIF ITALIC SMALL O |
| `𝘱` | `\mathsfit{p}` | MATHEMATICAL SANS-SERIF ITALIC SMALL P |
| `𝘲` | `\mathsfit{q}` | MATHEMATICAL SANS-SERIF ITALIC SMALL Q |
| `𝘳` | `\mathsfit{r}` | MATHEMATICAL SANS-SERIF ITALIC SMALL R |
| `𝘴` | `\mathsfit{s}` | MATHEMATICAL SANS-SERIF ITALIC SMALL S |
| `𝘵` | `\mathsfit{t}` | MATHEMATICAL SANS-SERIF ITALIC SMALL T |
| `𝘶` | `\mathsfit{u}` | MATHEMATICAL SANS-SERIF ITALIC SMALL U |
| `𝘷` | `\mathsfit{v}` | MATHEMATICAL SANS-SERIF ITALIC SMALL V |
| `𝘸` | `\mathsfit{w}` | MATHEMATICAL SANS-SERIF ITALIC SMALL W |
| `𝘹` | `\mathsfit{x}` | MATHEMATICAL SANS-SERIF ITALIC SMALL X |
| `𝘺` | `\mathsfit{y}` | MATHEMATICAL SANS-SERIF ITALIC SMALL Y |
| `𝘻` | `\mathsfit{z}` | MATHEMATICAL SANS-SERIF ITALIC SMALL Z |
| `𝘼` | `\mathsfbfit{A}` | MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL A |
| `𝘽` | `\mathsfbfit{B}` | MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL B |
| `𝘾` | `\mathsfbfit{C}` | MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL C |
| `𝘿` | `\mathsfbfit{D}` | MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL D |
| `𝙀` | `\mathsfbfit{E}` | MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL E |
| `𝙁` | `\mathsfbfit{F}` | MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL F |
| `𝙂` | `\mathsfbfit{G}` | MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL G |
| `𝙃` | `\mathsfbfit{H}` | MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL H |
| `𝙄` | `\mathsfbfit{I}` | MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL I |
| `𝙅` | `\mathsfbfit{J}` | MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL J |
| `𝙆` | `\mathsfbfit{K}` | MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL K |
| `𝙇` | `\mathsfbfit{L}` | MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL L |
| `𝙈` | `\mathsfbfit{M}` | MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL M |
| `𝙉` | `\mathsfbfit{N}` | MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL N |
| `𝙊` | `\mathsfbfit{O}` | MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL O |
| `𝙋` | `\mathsfbfit{P}` | MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL P |
| `𝙌` | `\mathsfbfit{Q}` | MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL Q |
| `𝙍` | `\mathsfbfit{R}` | MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL R |
| `𝙎` | `\mathsfbfit{S}` | MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL S |
| `𝙏` | `\mathsfbfit{T}` | MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL T |
| `𝙐` | `\mathsfbfit{U}` | MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL U |
| `𝙑` | `\mathsfbfit{V}` | MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL V |
| `𝙒` | `\mathsfbfit{W}` | MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL W |
| `𝙓` | `\mathsfbfit{X}` | MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL X |
| `𝙔` | `\mathsfbfit{Y}` | MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL Y |
| `𝙕` | `\mathsfbfit{Z}` | MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL Z |
| `𝙖` | `\mathsfbfit{a}` | MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL A |
| `𝙗` | `\mathsfbfit{b}` | MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL B |
| `𝙘` | `\mathsfbfit{c}` | MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL C |
| `𝙙` | `\mathsfbfit{d}` | MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL D |
| `𝙚` | `\mathsfbfit{e}` | MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL E |
| `𝙛` | `\mathsfbfit{f}` | MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL F |
| `𝙜` | `\mathsfbfit{g}` | MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL G |
| `𝙝` | `\mathsfbfit{h}` | MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL H |
| `𝙞` | `\mathsfbfit{i}` | MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL I |
| `𝙟` | `\mathsfbfit{j}` | MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL J |
| `𝙠` | `\mathsfbfit{k}` | MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL K |
| `𝙡` | `\mathsfbfit{l}` | MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL L |
| `𝙢` | `\mathsfbfit{m}` | MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL M |
| `𝙣` | `\mathsfbfit{n}` | MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL N |
| `𝙤` | `\mathsfbfit{o}` | MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL O |
| `𝙥` | `\mathsfbfit{p}` | MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL P |
| `𝙦` | `\mathsfbfit{q}` | MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL Q |
| `𝙧` | `\mathsfbfit{r}` | MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL R |
| `𝙨` | `\mathsfbfit{s}` | MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL S |
| `𝙩` | `\mathsfbfit{t}` | MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL T |
| `𝙪` | `\mathsfbfit{u}` | MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL U |
| `𝙫` | `\mathsfbfit{v}` | MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL V |
| `𝙬` | `\mathsfbfit{w}` | MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL W |
| `𝙭` | `\mathsfbfit{x}` | MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL X |
| `𝙮` | `\mathsfbfit{y}` | MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL Y |
| `𝙯` | `\mathsfbfit{z}` | MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL Z |
...
| `𝚨` | `\mbfAlpha` | MATHEMATICAL BOLD CAPITAL ALPHA |
| `𝚩` | `\mbfBeta` | MATHEMATICAL BOLD CAPITAL BETA |
| `𝚪` | `\mathbf{\Gamma}` | MATHEMATICAL BOLD CAPITAL GAMMA |
| `𝚫` | `\mathbf{\Delta}` | MATHEMATICAL BOLD CAPITAL DELTA |
| `𝚬` | `\mbfEpsilon` | MATHEMATICAL BOLD CAPITAL EPSILON |
| `𝚭` | `\mbfZeta` | MATHEMATICAL BOLD CAPITAL ZETA |
| `𝚮` | `\mbfEta` | MATHEMATICAL BOLD CAPITAL ETA |
| `𝚯` | `\mathbf{\Theta}` | MATHEMATICAL BOLD CAPITAL THETA |
| `𝚰` | `\mbfIota` | MATHEMATICAL BOLD CAPITAL IOTA |
| `𝚱` | `\mbfKappa` | MATHEMATICAL BOLD CAPITAL KAPPA |
| `𝚲` | `\mathbf{\Lambda}` |  |
| `𝚳` | `\mbfMu` | MATHEMATICAL BOLD CAPITAL MU |
| `𝚴` | `\mbfNu` | MATHEMATICAL BOLD CAPITAL NU |
| `𝚵` | `\mathbf{\Xi}` | MATHEMATICAL BOLD CAPITAL XI |
| `𝚶` | `\mbfOmicron` | MATHEMATICAL BOLD CAPITAL OMICRON |
| `𝚷` | `\mathbf{\Pi}` | MATHEMATICAL BOLD CAPITAL PI |
| `𝚸` | `\mbfRho` | MATHEMATICAL BOLD CAPITAL RHO |
| `𝚹` | `\mbfvarTheta` | MATHEMATICAL BOLD CAPITAL THETA SYMBOL |
| `𝚺` | `\mathbf{\Sigma}` | MATHEMATICAL BOLD CAPITAL SIGMA |
| `𝚻` | `\mbfTau` | MATHEMATICAL BOLD CAPITAL TAU |
| `𝚼` | `\mathbf{\Upsilon}` | MATHEMATICAL BOLD CAPITAL UPSILON |
| `𝚽` | `\mathbf{\Phi}` | MATHEMATICAL BOLD CAPITAL PHI |
| `𝚾` | `\mbfChi` | MATHEMATICAL BOLD CAPITAL CHI |
...
| `𝛆` | `\mathbf{\varepsilon}` | MATHEMATICAL BOLD SMALL EPSILON |
...
| `𝛌` | `\mathbf{\lambda}` |  |
| `𝛍` | `\mathbf{\mu}` | MATHEMATICAL BOLD SMALL MU |
| `𝛎` | `\mathbf{\nu}` | MATHEMATICAL BOLD SMALL NU |
| `𝛏` | `\mathbf{\xi}` | MATHEMATICAL BOLD SMALL XI |
| `𝛐` | `\mbfomicron` | MATHEMATICAL BOLD SMALL OMICRON |
...
| `𝛕` | `\mathbf{\tau}` | MATHEMATICAL BOLD SMALL TAU |
| `𝛖` | `\mathbf{\upsilon}` | MATHEMATICAL BOLD SMALL UPSILON |
| `𝛗` | `\mathbf{\varphi}` | MATHEMATICAL BOLD SMALL PHI |
...
| `𝛜` | `\mathbf{\epsilon}` | MATHEMATICAL BOLD EPSILON SYMBOL |
| `𝛝` | `\mathbf{\vartheta}` | MATHEMATICAL BOLD THETA SYMBOL |
| `𝛞` | `\mbfvarkappa` | MATHEMATICAL BOLD KAPPA SYMBOL |
...
| `𝛢` | `\mitAlpha` | MATHEMATICAL ITALIC CAPITAL ALPHA |
| `𝛣` | `\mitBeta` | MATHEMATICAL ITALIC CAPITAL BETA |
| `𝛦` | `\mitEpsilon` | MATHEMATICAL ITALIC CAPITAL EPSILON |
| `𝛧` | `\mitZeta` | MATHEMATICAL ITALIC CAPITAL ZETA |
| `𝛨` | `\mitEta` | MATHEMATICAL ITALIC CAPITAL ETA |
| `𝛪` | `\mitIota` | MATHEMATICAL ITALIC CAPITAL IOTA |
| `𝛫` | `\mitKappa` | MATHEMATICAL ITALIC CAPITAL KAPPA |
| `𝛭` | `\mitMu` | MATHEMATICAL ITALIC CAPITAL MU |
| `𝛮` | `\mitNu` | MATHEMATICAL ITALIC CAPITAL NU |
| `𝛰` | `\mitOmicron` | MATHEMATICAL ITALIC CAPITAL OMICRON |
| `𝛲` | `\mitRho` | MATHEMATICAL ITALIC CAPITAL RHO |
| `𝛳` | `\mitvarTheta` | MATHEMATICAL ITALIC CAPITAL THETA SYMBOL |
| `𝛵` | `\mitTau` | MATHEMATICAL ITALIC CAPITAL TAU |
| `𝛸` | `\mitChi` | MATHEMATICAL ITALIC CAPITAL CHI |
| `𝜊` | `\mitomicron` | MATHEMATICAL ITALIC SMALL OMICRON |
| `𝜜` | `\mbfitAlpha` | MATHEMATICAL BOLD ITALIC CAPITAL ALPHA |
| `𝜝` | `\mbfitBeta` | MATHEMATICAL BOLD ITALIC CAPITAL BETA |
| `𝜞` | `\mathbfit{\Gamma}` | MATHEMATICAL BOLD ITALIC CAPITAL GAMMA |
| `𝜟` | `\mathbfit{\Delta}` | MATHEMATICAL BOLD ITALIC CAPITAL DELTA |
| `𝜠` | `\mbfitEpsilon` | MATHEMATICAL BOLD ITALIC CAPITAL EPSILON |
| `𝜡` | `\mbfitZeta` | MATHEMATICAL BOLD ITALIC CAPITAL ZETA |
| `𝜢` | `\mbfitEta` | MATHEMATICAL BOLD ITALIC CAPITAL ETA |
| `𝜣` | `\mathbfit{\Theta}` | MATHEMATICAL BOLD ITALIC CAPITAL THETA |
| `𝜤` | `\mbfitIota` | MATHEMATICAL BOLD ITALIC CAPITAL IOTA |
| `𝜥` | `\mbfitKappa` | MATHEMATICAL BOLD ITALIC CAPITAL KAPPA |
| `𝜦` | `\mathbfit{\Lambda}` |  |
| `𝜧` | `\mbfitMu` | MATHEMATICAL BOLD ITALIC CAPITAL MU |
| `𝜨` | `\mbfitNu` | MATHEMATICAL BOLD ITALIC CAPITAL NU |
| `𝜩` | `\mathbfit{\Xi}` | MATHEMATICAL BOLD ITALIC CAPITAL XI |
| `𝜪` | `\mbfitOmicron` | MATHEMATICAL BOLD ITALIC CAPITAL OMICRON |
| `𝜫` | `\mathbfit{\Pi}` | MATHEMATICAL BOLD ITALIC CAPITAL PI |
| `𝜬` | `\mbfitRho` | MATHEMATICAL BOLD ITALIC CAPITAL RHO |
| `𝜭` | `\mbfitvarTheta` | MATHEMATICAL BOLD ITALIC CAPITAL THETA SYMBOL |
| `𝜮` | `\mathbfit{\Sigma}` | MATHEMATICAL BOLD ITALIC CAPITAL SIGMA |
| `𝜯` | `\mbfitTau` | MATHEMATICAL BOLD ITALIC CAPITAL TAU |
| `𝜰` | `\mathbfit{\Upsilon}` | MATHEMATICAL BOLD ITALIC CAPITAL UPSILON |
| `𝜱` | `\mathbfit{\Phi}` | MATHEMATICAL BOLD ITALIC CAPITAL PHI |
| `𝜲` | `\mbfitChi` | MATHEMATICAL BOLD ITALIC CAPITAL CHI |
| `𝜳` | `\mathbfit{\Psi}` | MATHEMATICAL BOLD ITALIC CAPITAL PSI |
| `𝜴` | `\mathbfit{\Omega}` | MATHEMATICAL BOLD ITALIC CAPITAL OMEGA |
| `𝜶` | `\mathbfit{\alpha}` | MATHEMATICAL BOLD ITALIC SMALL ALPHA |
| `𝜷` | `\mathbfit{\beta}` | MATHEMATICAL BOLD ITALIC SMALL BETA |
| `𝜸` | `\mathbfit{\gamma}` | MATHEMATICAL BOLD ITALIC SMALL GAMMA |
| `𝜹` | `\mathbfit{\delta}` | MATHEMATICAL BOLD ITALIC SMALL DELTA |
| `𝜺` | `\mathbfit{\varepsilon}` | MATHEMATICAL BOLD ITALIC SMALL EPSILON |
| `𝜻` | `\mathbfit{\zeta}` | MATHEMATICAL BOLD ITALIC SMALL ZETA |
| `𝜼` | `\mathbfit{\eta}` | MATHEMATICAL BOLD ITALIC SMALL ETA |
| `𝜽` | `\mathbfit{\theta}` | MATHEMATICAL BOLD ITALIC SMALL THETA |
| `𝜾` | `\mathbfit{\iota}` | MATHEMATICAL BOLD ITALIC SMALL IOTA |
| `𝜿` | `\mathbfit{\kappa}` | MATHEMATICAL BOLD ITALIC SMALL KAPPA |
| `𝝀` | `\mathbfit{\lambda}` |  |
| `𝝁` | `\mathbfit{\mu}` | MATHEMATICAL BOLD ITALIC SMALL MU |
| `𝝂` | `\mathbfit{\nu}` | MATHEMATICAL BOLD ITALIC SMALL NU |
| `𝝃` | `\mathbfit{\xi}` | MATHEMATICAL BOLD ITALIC SMALL XI |
| `𝝄` | `\mbfitomicron` | MATHEMATICAL BOLD ITALIC SMALL OMICRON |
| `𝝅` | `\mathbfit{\pi}` | MATHEMATICAL BOLD ITALIC SMALL PI |
| `𝝆` | `\mathbfit{\rho}` | MATHEMATICAL BOLD ITALIC SMALL RHO |
| `𝝇` | `\mathbfit{\varsigma}` | MATHEMATICAL BOLD ITALIC SMALL FINAL SIGMA |
| `𝝈` | `\mathbfit{\sigma}` | MATHEMATICAL BOLD ITALIC SMALL SIGMA |
| `𝝉` | `\mathbfit{\tau}` | MATHEMATICAL BOLD ITALIC SMALL TAU |
| `𝝊` | `\mathbfit{\upsilon}` | MATHEMATICAL BOLD ITALIC SMALL UPSILON |
| `𝝋` | `\mathbfit{\varphi}` | MATHEMATICAL BOLD ITALIC SMALL PHI |
| `𝝌` | `\mathbfit{\chi}` | MATHEMATICAL BOLD ITALIC SMALL CHI |
| `𝝍` | `\mathbfit{\psi}` | MATHEMATICAL BOLD ITALIC SMALL PSI |
| `𝝎` | `\mathbfit{\omega}` | MATHEMATICAL BOLD ITALIC SMALL OMEGA |
| `𝝐` | `\mathbfit{\epsilon}` | MATHEMATICAL BOLD ITALIC EPSILON SYMBOL |
| `𝝑` | `\mathbfit{\vartheta}` | MATHEMATICAL BOLD ITALIC THETA SYMBOL |
| `𝝒` | `\mbfitvarkappa` | MATHEMATICAL BOLD ITALIC KAPPA SYMBOL |
| `𝝓` | `\mathbfit{\phi}` | MATHEMATICAL BOLD ITALIC PHI SYMBOL |
| `𝝔` | `\mathbfit{\varrho}` | MATHEMATICAL BOLD ITALIC RHO SYMBOL |
| `𝝕` | `\mathbfit{\varpi}` | MATHEMATICAL BOLD ITALIC PI SYMBOL |
| `𝝖` | `\mbfsansAlpha` | MATHEMATICAL SANS-SERIF BOLD CAPITAL ALPHA |
| `𝝗` | `\mbfsansBeta` | MATHEMATICAL SANS-SERIF BOLD CAPITAL BETA |
| `𝝘` | `\mathsfbf{\Gamma}` | MATHEMATICAL SANS-SERIF BOLD CAPITAL GAMMA |
| `𝝙` | `\mathsfbf{\Delta}` | MATHEMATICAL SANS-SERIF BOLD CAPITAL DELTA |
| `𝝚` | `\mbfsansEpsilon` | MATHEMATICAL SANS-SERIF BOLD CAPITAL EPSILON |
| `𝝛` | `\mbfsansZeta` | MATHEMATICAL SANS-SERIF BOLD CAPITAL ZETA |
| `𝝜` | `\mbfsansEta` | MATHEMATICAL SANS-SERIF BOLD CAPITAL ETA |
| `𝝝` | `\mathsfbf{\Theta}` | MATHEMATICAL SANS-SERIF BOLD CAPITAL THETA |
| `𝝞` | `\mbfsansIota` | MATHEMATICAL SANS-SERIF BOLD CAPITAL IOTA |
| `𝝟` | `\mbfsansKappa` | MATHEMATICAL SANS-SERIF BOLD CAPITAL KAPPA |
| `𝝠` | `\mathsfbf{\Lambda}` |  |
| `𝝡` | `\mbfsansMu` | MATHEMATICAL SANS-SERIF BOLD CAPITAL MU |
| `𝝢` | `\mbfsansNu` | MATHEMATICAL SANS-SERIF BOLD CAPITAL NU |
| `𝝣` | `\mathsfbf{\Xi}` | MATHEMATICAL SANS-SERIF BOLD CAPITAL XI |
| `𝝤` | `\mbfsansOmicron` | MATHEMATICAL SANS-SERIF BOLD CAPITAL OMICRON |
| `𝝥` | `\mathsfbf{\Pi}` | MATHEMATICAL SANS-SERIF BOLD CAPITAL PI |
| `𝝦` | `\mbfsansRho` | MATHEMATICAL SANS-SERIF BOLD CAPITAL RHO |
| `𝝧` | `\mbfsansvarTheta` | MATHEMATICAL SANS-SERIF BOLD CAPITAL THETA SYMBOL |
| `𝝨` | `\mathsfbf{\Sigma}` | MATHEMATICAL SANS-SERIF BOLD CAPITAL SIGMA |
| `𝝩` | `\mbfsansTau` | MATHEMATICAL SANS-SERIF BOLD CAPITAL TAU |
| `𝝪` | `\mathsfbf{\Upsilon}` | MATHEMATICAL SANS-SERIF BOLD CAPITAL UPSILON |
| `𝝫` | `\mathsfbf{\Phi}` | MATHEMATICAL SANS-SERIF BOLD CAPITAL PHI |
| `𝝬` | `\mbfsansChi` | MATHEMATICAL SANS-SERIF BOLD CAPITAL CHI |
...
| `𝞃` | `\mathsfbf{\tau}` | MATHEMATICAL SANS-SERIF BOLD SMALL TAU |
| `𝞄` | `\mathsfbf{\upsilon}` | MATHEMATICAL SANS-SERIF BOLD SMALL UPSILON |
| `𝞅` | `\mathsfbf{\varphi}` | MATHEMATICAL SANS-SERIF BOLD SMALL PHI |
...
| `𝞊` | `\mathsfbf{\epsilon}` | MATHEMATICAL SANS-SERIF BOLD EPSILON SYMBOL |
| `𝞋` | `\mathsfbf{\vartheta}` | MATHEMATICAL SANS-SERIF BOLD THETA SYMBOL |
| `𝞌` | `\mbfsansvarkappa` | MATHEMATICAL SANS-SERIF BOLD KAPPA SYMBOL |
...
| `𝞐` | `\mbfitsansAlpha` | MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL ALPHA |
| `𝞑` | `\mbfitsansBeta` | MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL BETA |
| `𝞒` | `\mathsfbfit{\Gamma}` | MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL GAMMA |
| `𝞓` | `\mathsfbfit{\Delta}` | MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL DELTA |
| `𝞔` | `\mbfitsansEpsilon` | MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL EPSILON |
| `𝞕` | `\mbfitsansZeta` | MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL ZETA |
| `𝞖` | `\mbfitsansEta` | MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL ETA |
| `𝞗` | `\mathsfbfit{\Theta}` | MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL THETA |
| `𝞘` | `\mbfitsansIota` | MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL IOTA |
| `𝞙` | `\mbfitsansKappa` | MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL KAPPA |
| `𝞚` | `\mathsfbfit{\Lambda}` |  |
| `𝞛` | `\mbfitsansMu` | MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL MU |
| `𝞜` | `\mbfitsansNu` | MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL NU |
| `𝞝` | `\mathsfbfit{\Xi}` | MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL XI |
| `𝞞` | `\mbfitsansOmicron` | MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL OMICRON |
| `𝞟` | `\mathsfbfit{\Pi}` | MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL PI |
| `𝞠` | `\mbfitsansRho` | MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL RHO |
| `𝞡` | `\mbfitsansvarTheta` | MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL THETA SYMBOL |
| `𝞢` | `\mathsfbfit{\Sigma}` | MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL SIGMA |
| `𝞣` | `\mbfitsansTau` | MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL TAU |
| `𝞤` | `\mathsfbfit{\Upsilon}` | MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL UPSILON |
| `𝞥` | `\mathsfbfit{\Phi}` | MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL PHI |
| `𝞦` | `\mbfitsansChi` | MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL CHI |
| `𝞧` | `\mathsfbfit{\Psi}` | MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL PSI |
| `𝞨` | `\mathsfbfit{\Omega}` | MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL OMEGA |
| `𝞪` | `\mathsfbfit{\alpha}` | MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL ALPHA |
| `𝞫` | `\mathsfbfit{\beta}` | MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL BETA |
| `𝞬` | `\mathsfbfit{\gamma}` | MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL GAMMA |
| `𝞭` | `\mathsfbfit{\delta}` | MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL DELTA |
| `𝞮` | `\mathsfbfit{\varepsilon}` | MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL EPSILON |
| `𝞯` | `\mathsfbfit{\zeta}` | MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL ZETA |
| `𝞰` | `\mathsfbfit{\eta}` | MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL ETA |
| `𝞱` | `\mathsfbfit{\theta}` | MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL THETA |
| `𝞲` | `\mathsfbfit{\iota}` | MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL IOTA |
| `𝞳` | `\mathsfbfit{\kappa}` | MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL KAPPA |
| `𝞴` | `\mathsfbfit{\lambda}` |  |
| `𝞵` | `\mathsfbfit{\mu}` | MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL MU |
| `𝞶` | `\mathsfbfit{\nu}` | MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL NU |
| `𝞷` | `\mathsfbfit{\xi}` | MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL XI |
| `𝞸` | `\mbfitsansomicron` | MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL OMICRON |
| `𝞹` | `\mathsfbfit{\pi}` | MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL PI |
| `𝞺` | `\mathsfbfit{\rho}` | MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL RHO |
| `𝞻` | `\mathsfbfit{\varsigma}` | MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL FINAL SIGMA |
| `𝞼` | `\mathsfbfit{\sigma}` | MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL SIGMA |
| `𝞽` | `\mathsfbfit{\tau}` | MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL TAU |
| `𝞾` | `\mathsfbfit{\upsilon}` | MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL UPSILON |
| `𝞿` | `\mathsfbfit{\varphi}` | MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL PHI |
| `𝟀` | `\mathsfbfit{\chi}` | MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL CHI |
| `𝟁` | `\mathsfbfit{\psi}` | MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL PSI |
| `𝟂` | `\mathsfbfit{\omega}` | MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL OMEGA |
| `𝟄` | `\mathsfbfit{\epsilon}` | MATHEMATICAL SANS-SERIF BOLD ITALIC EPSILON SYMBOL |
| `𝟅` | `\mathsfbfit{\vartheta}` | MATHEMATICAL SANS-SERIF BOLD ITALIC THETA SYMBOL |
| `𝟆` | `\mbfitsansvarkappa` | MATHEMATICAL SANS-SERIF BOLD ITALIC KAPPA SYMBOL |
| `𝟇` | `\mathsfbfit{\phi}` | MATHEMATICAL SANS-SERIF BOLD ITALIC PHI SYMBOL |
| `𝟈` | `\mathsfbfit{\varrho}` | MATHEMATICAL SANS-SERIF BOLD ITALIC RHO SYMBOL |
| `𝟉` | `\mathsfbfit{\varpi}` | MATHEMATICAL SANS-SERIF BOLD ITALIC PI SYMBOL |
